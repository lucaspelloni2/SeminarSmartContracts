...
\subsection{Smart Contracts and Blockchain technology}
           \begin{figure}[H]
         \begin{center}
         \includegraphics[scale=0.4]{Talk3/img/sc_blockchain}
         \end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{Talk3/img/rubixi}
\end{center}
...
A category of very common bugs in Software Engineering areas are \textit{variable/function mixups}. \\
One example of this type of bug on Ethereum is \textit{Rubixi} \cite{rubixi1}.
