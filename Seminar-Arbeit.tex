...
In the figure below, you can find a list of the main companies and banks which have been looking for integrating blockchain technology in their activities: 
           \begin{figure}[H]
         \begin{center}
         \includegraphics[scale=0.45]{Talk3/img/bank}
         \end{center}
...
The graph below shows the Bitcoins's growth in relation with the Blockchain investments from 2011 to 2015\footnote{A more detailed analysis can be found here \cite{aaa}} \\
           ...
           \begin{figure}[H]
         \begin{center}
         \includegraphics[scale=0.45]{Talk3/img/bit}
         \end{center}
...
A \textit{traditional contract} is normally an agreement, which consciously and legally binds two or more parties, who accept the terms and conditions contained inside the contract after different rounds of negotiations \cite{SC12,SC13}. For the execution of a \textit{traditional contract} there is always a need of a middleman (\textit{e.g. a lawyer}), who verifies and checks the agreed terms within the contract. However, this kind of a deal can imply excessive costs, may be prone to delays or might cause misunderstandings between the parties. 
           \begin{figure}[H]
         \begin{center}
         \includegraphics[scale=0.30]{Talk3/img/tradVSsmart}
         \end{center}
...
\subsection{Smart Contracts and Blockchain technology}
           \begin{figure}[H]
         \begin{center}
         \includegraphics[scale=0.52]{Talk3/img/sc_blockchain}
         \end{center}
...
It has been invented by \textit{Vitalik Buterin}, a russian programmer. 
           \begin{figure}[H]
         \begin{center}
         \includegraphics[scale=0.09]{Talk3/img/vitalik}
         \end{center}
...
On 17 June 2016, the attacker managed to steal 3.6 Milion Ether\footnote{Corresponding to USD 60 million} from the Ethereum's platform and put them into a personal account \cite{SC8}.\\ %http://www.clydeco.com/insight/article/ethereums-dao-attack-smart-contracts-and-blockchain-face-their-first-big-te
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.69]{Talk3/img/dao1}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.67]{Talk3/img/dao2}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.38]{Talk3/img/ponzi}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.43]{Talk3/img/rubixi}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.72]{Talk3/img/kot}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.51]{Talk3/img/kot2}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.69]{Talk3/img/kot_mallory}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.43]{Talk3/img/Governmental1Array}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.51]{Talk3/img/GovernmentalContract}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.52]{Talk3/img/GovernmentAtttackContract}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.63]{Talk3/img/rubixi2}
\end{center}
...
\bibitem{vit}\emph{Vitalik Buterin: We are not opposed to Ethereum Classic}, \url{http://www.coinfox.info/news/6024-vitalik-buterin-we-are-not-opposed-to-ethereum-classic} (last accessed April 2017)


\bibitem{soci}\emph{Customer e traction}, \url{https://siamosoci.com/projects/323122719/blockchain-club} (last accessed April 2017)


\bibitem{soci}\emph{Charlie Ponzi}, \url{https://culturificio.org/lo-schema-ponzi/} (last accessed Mai 2017)

\bibitem{aaa}\emph{Global investments in FinTech startups booms to 19 billion}, \url{http://www.consultancy.uk/news/3392/global-investments-in-fintech-startups-booms-to-19-billion
} (last accessed Mai 2017)

\bibitem{kingoftheether}\emph{King of the Ether game}, \url{https://www.kingoftheether.com
} (last accessed Mai 2017)



\bibitem{kotetIT}\emph{King of the Ether contract}, \url{http://co2.unica.it/ethereum/attacks.html#kotet} (last accessed Mai 2017)

\bibitem{ the contract}\emph{Main differences between send and call functions, \url{https://ethereum.stackexchange.com/questions/6470/send-vs-call-differences-and-when-to-use-and-when-not-to-use} (last accessed Mai 2017)
