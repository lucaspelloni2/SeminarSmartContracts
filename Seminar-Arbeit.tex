...
A \textit{traditional contract} is normally an agreement, which consciously and legally bind two or more parties, who accept the terms and conditions contained inside the contract \cite{SC12}\cite{SC13}. For the execution of a \textit{traditional contract} there is always a need of a middleman (\textit{e.g. a lawyer}), who verifies and checks the agreed terms within the contract. However, this kind of a deal can imply excessive costs, may be prone to delays or might cause misunderstandings between the parties. 
           ...
           \begin{figure}[H]
         \begin{center}
         \includegraphics[scale=0.3]{Talk3/img/tradVSsmart}
         \end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{Talk3/img/oae1}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{Talk3/img/Governmental1Array}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{Talk3/img/GovernmentalContract}
\end{center}
\caption{Clearing the two arrays}
\label{label}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{Talk3/img/GovernmentAtttackContract}
\end{center}
...
\bibitem{SC14}\emph{title.}\url{url} (last accessed April 2017)
\bibitem{SC15}\emph{title.}\url{url} (last accessed February 2017)
\bibitem{SC16}\emph{title.}\url{url} (last accessed April 2017)
\bibitem{SC17}\emph{title.}\url{url} (last accessed March 2017)
\bibitem{SC18}\emph{title.}\url{url} (last accessed April 2017)
\bibitem{SC19}\emph{title.}\url{url} (last accessed March 2017)
\bibitem{SC20}\emph{title.}\url{url} (last accessed April 2017)
\bibitem{SC21}\emph{title.}\url{url} (last accessed March 2017)
\bibitem{SC22}\emph{title.}\url{url} (last accessed April 2017)
\bibitem{SC23}\emph{title.}\url{url} (last accessed March 2017)
