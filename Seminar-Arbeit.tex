...
To join a game,  the function at line 18 gets invoked and immediately at line 21, it checks whether the players have bet 1 Ether. If that is not the case, an exception gets thrown and the amount is sent back to the player.
